...
TICKER_MAP = {
    ...
    '腾讯': ('0700.HK', 'Tencent', 'HKEX', '互联网/游戏/金融科技', AssetCategory.HK_STOCK),
    '阿里巴巴': ('9988.HK', 'Alibaba', 'HKEX', '电商/云计算', AssetCategory.HK_STOCK),
    '美团': ('3690.HK', 'Meituan', 'HKEX', '本地生活/平台经济', AssetCategory.HK_STOCK),
    '比亚迪': ('1211.HK', 'BYD', 'HKEX', '新能源汽车/电池', AssetCategory.HK_STOCK),
    '丰田': ('7203.T', 'Toyota Motor', 'TYO', '汽车/制造', AssetCategory.STOCK),
    '索尼': ('6758.T', 'Sony Group', 'TYO', '消费电子/娱乐', AssetCategory.STOCK),
    '软银集团': ('9984.T', 'SoftBank Group', 'TYO', '科技投资/通信', AssetCategory.STOCK),
    '比特币': ('BTC', 'Bitcoin', 'Crypto', '加密货币', AssetCategory.CRYPTO),
    '以太坊': ('ETH', 'Ethereum', 'Crypto', '加密货币/L1', AssetCategory.CRYPTO),
    'Solana': ('SOL', 'Solana', 'Crypto', '加密货币/L1', AssetCategory.CRYPTO),
    '索拉纳': ('SOL', 'Solana', 'Crypto', '加密货币/L1', AssetCategory.CRYPTO),
    'BNB': ('BNB', 'BNB', 'Crypto', '加密货币/L1', AssetCategory.CRYPTO),
